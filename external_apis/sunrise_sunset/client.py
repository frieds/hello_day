...
def get_sunrise_sunset_times(latitude: float, longitude: float, date_value: date) -> SunriseSunsetResponse:
    query_params = SunriseSunsetQueryParams(latitude=latitude, longitude=longitude, date=date_value)
