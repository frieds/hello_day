...
from external_apis.sunrise_sunset.schemas import SunriseSunsetQueryParams, SunriseSunsetResponse

_BASE_URL = "https://api.sunrise-sunset.org/json"


def get_sunrise_sunset_times(latitude: float, longitude: float, date_value: Optional[date] = None) -> \
